...
title: | 
  ...
  | 2022-2023
author: |
  | Xie Rongzhen (5336961)
  | r.xie1@students.uu.nl
  | https://github.com/xrz6260951/Test2.git
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
#The p-value is 0.06871, which is bigger than alpha value 0.05. So we do not have sufficient evidence to reject zero hypothesis,which is true difference in means between group no revolutions and group revolutions is equal to 0.
...
Including this variable in the model allows us to control for countries' initial economic conditions. It is often necessary to control for these variables to isolate the effects of variable of treat.The variable rgdp60 is the value of GDP per capita in 1960, converted to 1960 US dollars.
...
According to this analysis，the tradeshare is the main driver of economic.Because the tradeshare coefficient of growth rate is 2.306, which is the biggest coefficient over this four variables.This means that when the tradeshare increased by 1 unit, the growth rate will also increased by 2.306 units.
